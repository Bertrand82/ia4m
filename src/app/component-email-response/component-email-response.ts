...
export const reponseGenerationMessage = {
  ...
  properties: {
    noReply: {
      type: 'boolean',      
      description: 'No reply to the email',
    },
    noReplyAdvice: {
      type: 'boolean',      
      description: 'Reply to the email is not necessary',
    },
    replyExpected: {
      type: 'boolean',      
      description: 'Reply to the email is expected',
    },
    responseShort: {
      type: 'string',
  ...
  required: ['responseShort', 'responseLong', 'confidence', 'noReply', 'noReplyAdvice', 'replyExpected'],
};
